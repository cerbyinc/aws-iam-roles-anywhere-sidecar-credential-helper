...
COPY . /go/src/github.com/cerbyinc/aws-iam-roles-anywhere-sidecar-credential-helper
RUN cd /go/src/github.com/cerbyinc/aws-iam-roles-anywhere-sidecar-credential-helper && \
...
LABEL repo="https://github.com/cerbyinc/aws-iam-roles-anywhere-sidecar-credential-helper"
